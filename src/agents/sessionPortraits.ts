...
export const SESSION_AGENT_AVATARS = [
  { id: "agent-avatar-01", name: "Agent Avatar 01", asset: "/agent-avatars/06111fa874ffbdd38cd79bf40466d8e4.jpg", accent: "#3558a2", paper: "#e7edfa", focalPoint: "50% 44%" },
  ...
  { id: "agent-avatar-11", name: "Agent Avatar 11", asset: "/agent-avatars/e1033d8e1ecb6a1d9f047d218e630500.jpg", accent: "#3558a2", paper: "#e7edfa", focalPoint: "50% 42%" },
