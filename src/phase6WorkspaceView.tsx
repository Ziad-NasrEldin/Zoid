...
import { assertPhase6CalendarConfirmation, assertPhase6NoSilentSend, buildPhase6WorkspaceView, phase6SafeBridgeError } from "./phase6Workspace";
...
function CalendarActions({ invoke, onRefresh }: Pick<Phase6WorkspaceProps, "invoke" | "onRefresh">) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setState({ status: "error", message: phase6SafeBridgeError(error) });
    }
  }
  return (
