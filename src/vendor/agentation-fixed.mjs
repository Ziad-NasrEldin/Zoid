...
function DesignMode({
  ...
  const arrowColor = wireframe ? "#c23a2e" : "#3c82f7";
  const edgeHandles = [
...
function normalizeOutputDetail(detailLevel) {
  return OUTPUT_DETAIL_OPTIONS.some((option) => option.value === detailLevel) ? detailLevel : "standard";
}
function getOutputDetailLabel(detailLevel) {
  return OUTPUT_DETAIL_OPTIONS.find((option) => option.value === detailLevel)?.label ?? "Standard";
}
function generateOutput(annotations, pathname, detailLevel = "standard") {
  detailLevel = normalizeOutputDetail(detailLevel);
  if (annotations.length === 0) return "";
  const viewport = typeof window !== "undefined" ? `${window.innerWidth}\xD7${window.innerHeight}` : "unknown";
  let output = `## Page Feedback: ${pathname}
`;
  output += `**Output Detail:** ${getOutputDetailLabel(detailLevel)}
`;
  if (detailLevel === "forensic") {
    output += `
**Environment:**
...
var COLOR_OPTIONS = [
  ...
  { id: "seal", label: "Seal", srgb: "#C23A2E", p3: "color(display-p3 0.76 0.23 0.18)" },
...
function PageFeedbackToolbarCSS({
  ...
  const [settings, setSettings] = useState6(() => {
    try {
      ...
      const savedOutputDetail = OUTPUT_DETAIL_OPTIONS.find((option) => option.value === saved.outputDetail) ? saved.outputDetail : DEFAULT_SETTINGS.outputDetail;
      return {
        ...DEFAULT_SETTINGS,
        ...saved,
                      ...
                      /* @__PURE__ */ jsxs13("div", { className: styles_module_default4.buttonWrapper, children: [
                        /* @__PURE__ */ jsx14(
                          "button",
                          {
                            ...
                            style: isDesignMode && blankCanvas ? { color: "#c23a2e", background: "rgba(194, 58, 46, 0.14)" } : void 0,
                      ...
                      /* @__PURE__ */ jsxs13("div", { className: styles_module_default4.buttonWrapper, children: [
                        /* @__PURE__ */ jsx14(
                          "button",
                          {
                            ...
                            "data-active": copied,
                            children: /* @__PURE__ */ jsx14(IconCopyAnimated, { size: 24, copied, tint: isDesignMode && blankCanvas && (designPlacements.length > 0 || !!rearrangeState?.sections?.length) ? "#c23a2e" : void 0 })
                          }
                        ),
                        /* @__PURE__ */ jsxs13("span", { className: styles_module_default4.buttonTooltip, children: [
